...
class Command(BaseCommand): #2
	...
	def handle(self, *args, **options):
		for xml_file in options['xml_file']: #3
			...
			final = [{"type": "overview", "text":{"headline": title_fin, "text" : description},"media":{"url": "https://ds-omeka.haverford.edu/qi/files/fullsize/4e0fe986a9716456496045d5fe4f608f.jpg", "caption" : "First Page"} }] + objects
  ...
  <body>
	<header>
          <div class = "overlay-container">
            <img src="{% static "img/PennsTreaty-West.jpg" %}" alt="Header img" />
              <div class = "overlay1 show-for-large-up">
               <!--  <strong>Beyond Penn's Treaty</strong> -->
              </div>
        </div>
