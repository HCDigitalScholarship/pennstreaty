...
class PersonIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    birthdate = indexes.CharField(model_attr='birth_date', null=True)
    deathdate = indexes.CharField(model_attr='death_date', null=True)
    birthplace = indexes.CharField(model_attr='birth_place', null=True) #this is in the form of an id_tei (fix)
...
class OrgIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    place_id = indexes.CharField(model_attr='place_id', null=True)
    notes = indexes.CharField(model_attr='notes', null=True)
    ...
    date_founded = indexes.CharField(model_attr='date_founded', null=True)
...
class ManuscriptIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    person_id = indexes.CharField(model_attr='person_id', null=True)
