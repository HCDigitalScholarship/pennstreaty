...
class Place(models.Model):
    ...
    def __unicode__(self):
        return self.id_tei + " " + self.name + " " + self.state + " " + unicode(self.latitude) \
             + " " + unicode(self.longitude) + " " + self.notes + " " + self.notes2 + " "  \
             + unicode(self.place_type) + " " + self.alternate
...
class Manuscript(models.Model):
    ...
    org_id = models.ForeignKey("Org", blank=True, null=True, related_name="org_id_text")
...
class Page(models.Model):
    id_tei = models.CharField("TEI ID", max_length=50)
    Manuscript_id = models.ForeignKey("Manuscript", blank=True, null=True,
                                      related_name="Manuscript_id")
