    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_id', models.ForeignKey(related_name='place_id', blank=True, to='QI.Place', null=True,on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.AddField(
            model_name='page',
            name='text_id',
            field=models.ForeignKey(related_name='text_id', blank=True, to='QI.Text', null=True,on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='affiliation',
            name='org_id',
            field=models.ForeignKey(related_name='org_id', blank=True, to='QI.Org', null=True,on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='affiliation',
            name='person_id',
            field=models.ForeignKey(related_name='person_id', blank=True, to='QI.Person', null=True,on_delete=models.CASCADE),
        ),
    ]
