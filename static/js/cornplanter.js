...
$(".forwards-arrow i.fa.fa-chevron-right").click(function(){ //controls going forward in the image viewer
...
$(".forwards-arrow i.fa.fa-chevron-left").click(function(){ //controls going backward in the image viewer
